...
| **Stress-1 (real story, 7-axis judge)** | **5/5 PASS**, all **14/14**. Entry-scenario coverage on «[скрыто]». |
...
- **M2→M3 gate (NOT this stage):** calibration on ≥3 REAL PRDs with false-ABSENT rate checked. 1/3 secured («[скрыто]», `scratchpad/real-prd-holdirovanie.md`).
