...
- **Follow-up applied (2026-07-13):** priority-1 fixes **S1–S4 landed in SKILL.md** — REFUSAL UX anti-loop (verbatim once per block; gate never softens), owner never auto-defaulted, conversational/batch source counts, declared outcome elicits an enum status (no silent `new`; the delivered/done gap is surfaced). Verified by workflow `wf_2c6fd549-8c2`: adversarial patch review PASS (frozen contract intact, 1738 words) + 3 targeted retests 3/3 incl. a gate-regression probe (S-1 + no-re-scoring held under combined pressure). Registered as **v0.4.1**, cache byte-verified, 215/215 frozen hashes still OK. S5–S12 remain proposed-not-applied.
...
One-line ping: «opp-backlog skill at M2, plugin v0.4.1 (S1–S4 patch applied + retested post-wave), smoke 4/4 + stress 5/5 simulated (0 fix rounds), chief-gate SATISFIED 9/9, spec-friction: 8 build-side + 7 wave-side canon questions, real-data wave 12/12 spec-pass / PM-median ~6 with 12 skill-fixes (4 applied) + 8 lvl2-reqs proposed».
