...
1. **{Что не так: фраза причины из глоссария, привязанная к содержанию документа}**
...
{decision_flipping_observation словами}. В документе: {есть, вывод устоял | нет, наблюдение против вывода | проверить нельзя}.
